from src.processing import filter_by_state, sort_by_date, filter_by_search
...
def main():
    ...
    if user_choice_currency == 'да':
        try:
            filter_rub_transactions = [transaction for transaction in filter_status_and_date_transactions if
                                   transaction['currency_code'] == 'RUB']
        except KeyError:
            filter_rub_transactions = [transaction for transaction in filter_status_and_date_transactions if transaction["operationAmount"]["currency"][
                "code"] == 'RUB']
    ...
    # return filter_rub_transactions_search


# return user_choice_file
