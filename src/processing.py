...
def filter_by_state(list_dict: List[Dict[str, Any]], my_state: str = "EXECUTED") -> List[Dict[str, Any]]:
    ...
    result_list = [dictionary for dictionary in list_dict if dictionary["state"] == my_state]
    return result_list
...
if __name__ == '__main__':
    list123 = [{"id": 441945886, "state": "EXECUTED", "date": "2019-08-26T10:50:58.294041",
                "operationAmount": {"amount": "31957.58", "currency": {"name": "руб.", "code": "RUB"}},
                "description": "Поступление", "from": "Maestro 1596837868705199",
                "to": "Счет 64686473678894779589"},
               {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364", "operationAmount": {
                   "amount": "8221.37", "currency": {"name": "USD", "code": "USD"}},
                "description": "Поступление", "from": "MasterCard 7158300734726758",
