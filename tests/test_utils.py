...
def test_get_list_transactions_wrong():
    '''Проверка на неверный путь/несуществующий файл'''
...
def test_get_list_transactions():
    ...
    assert get_list_transactions(path='C:\\Users\\admin\Documents\Learn_Python\PC\Home_Work_9_2_Pestrakova\data\operations.json') == [
  {
    "id": 441945886,
    "state": "EXECUTED",
